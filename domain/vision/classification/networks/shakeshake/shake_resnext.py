...
from autoaugment.domain.vision.classification.networks.shakeshake.shakeshake import ShakeShake
from autoaugment.domain.vision.classification.networks.shakeshake.shakeshake import Shortcut
...
class ShakeBottleNeck(nn.Module):
    def __init__(self, in_ch, mid_ch, out_ch, cardinary, stride=1):
        ...
        self.shortcut = None if self.equal_io else Shortcut(
    ...
    def _make_branch(self, in_ch, mid_ch, out_ch, cardinary, stride=1):
        return nn.Sequential(
            ...
            nn.Conv2d(mid_ch,
                      ...
                      stride=stride,
                      groups=cardinary,
                      bias=False), nn.BatchNorm2d(mid_ch),
