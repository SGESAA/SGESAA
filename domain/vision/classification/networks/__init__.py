...
from autoaugment.domain.vision.classification.networks.resnet import ResNet
from autoaugment.domain.vision.classification.networks.pyramidnet import PyramidNet
from autoaugment.domain.vision.classification.networks.shakeshake.shake_resnet import ShakeResNet
from autoaugment.domain.vision.classification.networks.wideresnet import WideResNet
from autoaugment.domain.vision.classification.networks.shakeshake.shake_resnext import ShakeResNeXt
from autoaugment.domain.vision.classification.networks.efficientnet_pytorch.model import RoutingFn,\
    EfficientNet


def get_model(conf, num_class=10, local_rank=-1, gpu_id=None):
    name = conf['type']
    ...
    if local_rank >= 0:
        ...
        # if gpu_id is not None and type(gpu_id) == int:
