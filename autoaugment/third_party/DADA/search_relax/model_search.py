...
class MixedAugment(nn.Module):
    ...
    def forward(self, origin_images, probabilities_b, magnitudes, weights_b):
        return self._ops[weights_b.item()](origin_images,
...
class Network(nn.Module):
    def __init__(self, model_name, num_classes, sub_policies, use_cuda,
                 use_parallel, temperature, criterion):
    ...
    def new(self):
        network_new = Network(self.model_name, self.num_classes,
                              self.sub_policies, self.use_cuda,
                              self.use_parallel,
    ...
    def forward_train(self, origin_images):
        ...
        mix_image = self.mix_augment.forward(origin_images,
